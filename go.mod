...
require (
	...
	github.com/pulumi/pulumi-null/sdk v0.0.10 // indirect
	github.com/pulumi/pulumi-terraform-provider/sdks/go/castai/v7 v7.0.0-00010101000000-000000000000 // indirect
